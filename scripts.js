...
(function(){ 'use strict';
  ...
  g.SnakeTile.prototype.render = function( i ) {
    ...
    this.elem.style.rotate = this.rotate;
  };
...
(function(){ 'use strict';
  ...
  g.FoodTile.prototype.render = function() {
    ...
    this.elem.style.backgroundColor = 'hsla(' + this.hue + ', 100%, 60%, 0.3)';
    this.elem.style.boxShadow = '0 0 ' + this.blur + 'px hsla(' + this.hue + ', 100%, 60%, 1)';
    this.elem.style.fontSize = '3em';
